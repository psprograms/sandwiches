    ...
    case oid_response.status
      ...
      when OpenID::Consumer::SUCCESS
        ...
        if oid_response.status == OpenID::Consumer::SUCCESS
          ...
          domain = emailAry[1]
          if domain != 'students.westport.k12.ct.us' && domain != 'westport.k12.ct.us' && session[:email] != 'michael.adler.a@gmail.com' && session[:email] != 'pstakoff@gmail.com' && session[:email] != 'staples.lunch'
