...
@nowTime = Time.now()
@startTime = Time.new(@nowTime.year, @nowTime.month, @nowTime.day, 7, 30)
@endTime = Time.new(@nowTime.year, @nowTime.month, @nowTime.day, 9, 30)
Options.create(:optionName => 'Start Time', :value => @startTime)
Options.create(:optionName => 'End Time', :value => @endTime)
